...
cd /home/charles/Minecraft/Minecraft_1.20.4
echo "$(pwd)" > "$lock_file"
# cat "$lock_file"
screen -S minecraft -d -m /home/charles/Minecraft/Minecraft_1.20.4/run_server.sh -L -Logfile /home/charles/Minecraft/Minecraft_1.20.4/screen_log
